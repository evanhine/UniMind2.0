...
public class IngredientsAvailable_fetchData extends AsyncTask<Void, Void, Void>
{
    ...
    protected void onPostExecute(Void aVoid)
    {
        ...
        IngredientsAvailable.ingredientNames_IngredientsAvailable.setText(this.ingredientNamesParsed);
        IngredientsAvailable.ingredientIDs_IngredientsAvailable.setText(this.ingredientIDsParsed);
    }
}
